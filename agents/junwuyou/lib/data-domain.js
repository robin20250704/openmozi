// agents/junwuyou/lib/data-domain.js
//
...
// 本文件位于 runtime/openmozi/agents/junwuyou/lib/ → 上溯 3 级 = runtime/openmozi/，
...
/**
 * 本 agent 的身份（数据域查表的键）。由业务侧**显式声明**，理由见 yuanyi/lib/data-domain.js：
 * 工具执行不一定继承本轮对话的 await 链，靠上下文推断"当前是谁"会被兜底值答错。
 */
export const AGENT_ID = "junwuyou";
